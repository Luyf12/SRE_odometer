...
function Companyconstar2() {
  const chartRef = useRef(null);

  useEffect(() => {
    let chartInstance = echarts.init(chartRef.current);
    var plantCap = [
      { name: "Google", value: 189 },
      { name: "Microsoft", value: 164 },
      { name: "facebook", value: 139 },
      { name: "Tencent", value: 124 },
      { name: "Alibaba", value: 123 },
      { name: "Tsinghua University", value: 107 },
...
export default Companyconstar2;
